...
- Specs (brainstorming output) now save to `.specs/memory/docs/specs/YYYY-MM-DD-<topic>-design.md`
- Plans (writing-plans output) now save to `.specs/memory/docs/plans/YYYY-MM-DD-<feature-name>.md`
...
- Design spec and implementation plan in `.specs/memory/docs/`
