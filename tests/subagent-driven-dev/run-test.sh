...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/colbPowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/colbPowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using colbPowers:subagent-driven-development. The plan is at: $PLAN_PATH"
