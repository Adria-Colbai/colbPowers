...
mkdir -p src test .specs/memory/docs/plans

# Create a simple implementation plan
cat > .specs/memory/docs/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .specs/memory/docs/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from colbPowers directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at .specs/memory/docs/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"colbPowers:subagent-driven-development"' "$SESSION_FILE"; then
